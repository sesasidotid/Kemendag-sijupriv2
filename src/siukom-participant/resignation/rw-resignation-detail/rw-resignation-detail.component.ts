...
@Component({
    selector: 'app-rw-resignation-detail',
    standalone: true,
    imports: [CommonModule, TanggalIndoPipe, PrettyNamePipe],
    templateUrl: './rw-resignation-detail.component.html',
    styleUrl: './rw-resignation-detail.component.scss',
})
export class RwResignationDetailComponent {
    ...
    back() {
        this.router.navigate(['/resignation/riwayat'], {})
    }
