...
export const routes: Routes = [
    {
        ...
        loadComponent: () =>
            import(
                '../sijupri-jf/template/sijupri-jf/sijupri-jf.component'
            ).then((m) => m.SijupriJfComponent),
        ...
        children: [
            {
                ...
                loadComponent: () =>
                    import(
                        '../sijupri-jf/template/dashboard/dashboard.component'
            ...
            },
            {
                ...
                loadComponent: () =>
                    import(
                        '../sijupri-jf/template/profile/profile.component'
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        loadComponent: () =>
                            import(
                                '../sijupri-jf/template/riwayat/riwayat.component'
                            ).then((m) => m.RiwayatComponent),
                        children: [
                            {
                                path: '',
                                loadComponent: () =>
                            ...
                            },
                            {
                                ...
                                loadComponent: () =>
                                    import(
                                        ...
                                        (m) => m.RwPendidikanPendingComponent,
                                    ),
                            },
                            {
                                path: 'add',
                            ...
                            },
                            {
                                ...
                                loadComponent: () =>
                                    import(
                                        ...
                                        (m) => m.RwKompetensiPendingComponent,
                                    ),
                            },
                            {
                                path: 'add',
                            ...
                            },
                            {
                                ...
                                loadComponent: () =>
                                    import(
                                        ...
                                        (m) => m.RwSertifikasiPendingComponent,
                                    ),
                            },
                            {
                                path: 'add',
            ...
            ...(RouteLoader.loadRouter({
                UKom: {
                    'Pendaftaran Ukom': {
                        components: () =>
                            import(
                                '../sijupri-jf/ukom/ukom-task/ukom-task.component'
                            ).then((m) => m.UkomTaskComponent),
                        routes: [
                            {
                                path: ':id',
                                loadComponent: () =>
                    ...
                    'Riwayat Ukom': {
                        components: () =>
                            import(
                                '../sijupri-jf/ukom/ukom-list/ukom-list.component'
                ...
                AKP: {
                    'Penilaian AKP': {
                        components: () =>
                            import(
                                '../sijupri-jf/akp/akp-task/akp-task.component'
                            ).then((m) => m.AkpTaskComponent),
                    },
                    'Riwayat AKP': {
                        components: () =>
                            import(
                                '../sijupri-jf/akp/akp-list/akp-list.component'
                ...
                Formasi: {
                    'Daftar Formasi': {
                        components: () =>
                            import(
                                '../sijupri-jf/jf-formasi/jf-formasi.component'
                            ).then((m) => m.JfFormasiComponent),
                    },
                },
            }) ?? []),
        ],
