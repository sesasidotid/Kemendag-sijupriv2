    ...
    getPendingRWKompetensi(id: string) {
        ...
        this.apiService.getData(`/api/v1/pending_task/${id}`).subscribe({
            ...
            error: error => {
                ...
                this.alertService.showToast(
                    'Error',
                    'Gagal mendapatkan data riwayat Kompetensi!'
                )
            }
        })
    }
        ...
        if (this.rwKompetensiForm.valid) {
            ...
            this.confirmationService.open(false).subscribe({
                next: result => {
                    ...
                    this.apiService
                        .postData(`/api/v1/rw_kompetensi/task/submit`, task)
                        .subscribe({
                            next: () => {
                                this.alertService.showToast(
                                    'Success',
                                    'Berhasil mengubah riwayat kompetensi.'
                                )
                            ...
                            error: error => {
                                ...
                                this.alertService.showToast(
                                    'Error',
                                    'Gagal mengubah riwayat kompetensi.'
                                )
                            }
                        })
                }
