...
const DB_VERSION = 1
const STORE_NAME = 'wawancara_answers'
const TTL_MS = 24 * 60 * 60 * 1000 // 24 hours

export interface WawancaraDraft {
    key: string
    examId: string
    participantId: string
    answers: Record<string, WawancaraExamAnswer>
    expiresAt: number
    updatedAt: number
}
...
export class WawancaraDraftService {
    ...
    async load(
        ...
        return new Promise((resolve) => {
            ...
            req.onsuccess = () => {
                const result = req.result as WawancaraDraft | undefined
