...
@Component({
    selector: 'app-preview-studi-kasus',
    standalone: true,
    imports: [CommonModule],
    templateUrl: './preview-studi-kasus.component.html',
    styleUrl: './preview-studi-kasus.component.scss',
})
export class PreviewStudiKasusComponent {
