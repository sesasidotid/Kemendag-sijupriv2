...
@Component({
    selector: 'app-generic-score-admin',
    standalone: true,
    imports: [CommonModule],
    templateUrl: './generic-score-admin.component.html',
    styleUrl: './generic-score-admin.component.scss',
})
export class GenericScoreAdminComponent {
