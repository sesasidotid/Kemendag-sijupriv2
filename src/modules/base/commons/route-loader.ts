...
type ChilSpecification = { [key: string]: { components: () => Promise<any>, routes?: any[] } };
...
export class RouteLoader {
    ...
    private static loadChildRouter(childSpecification: ChilSpecification, childMenu: Menu[]): any[] {
        const routes: any[] = [];
