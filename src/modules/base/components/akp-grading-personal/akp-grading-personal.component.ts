        ...
        this.akpTaskService.getAKPByPersonal(this.AKPId).subscribe({
            next: (response) => {
                ...
                this.categoryLength$.next(
                    this.AKPGrading.dataPertanyaanList?.length,
                )
                this.updateCurrentQuestion()
            },
            complete: () => {
                    ...
                    if (subObject.hasOwnProperty(subKey)) {
                        ...
                        switch (field) {
                            case 'nilaiYbs':
                                ...
                                break
                            case 'nilaiRekan':
                                tempData[matrixId].nilaiRekan =
                                    subObject[subKey]
                                break
                            case 'nilaiAtasan':
                                tempData[matrixId].nilaiAtasan =
                                    subObject[subKey]
                                break
                            case 'nilai_penugasan':
                                tempData[matrixId].nilai_penugasan =
                                    subObject[subKey]
                                break
                            case 'nilai_materi':
                                tempData[matrixId].nilai_materi =
                                    subObject[subKey]
                                break
                            case 'nilai_informasi':
                                tempData[matrixId].nilai_informasi =
                                    subObject[subKey]
                                break
                            case 'nilai_standar':
                                tempData[matrixId].nilai_standar =
                                    subObject[subKey]
                                break
                            case 'nilai_metode':
                                tempData[matrixId].nilai_metode =
                                    subObject[subKey]
                                break
                            case 'nilai_waktu':
                                tempData[matrixId].nilai_waktu =
                                    subObject[subKey]
                                break
                            case 'nilai_kesulitan':
                                tempData[matrixId].nilai_kesulitan =
                                    subObject[subKey]
                                break
                            case 'nilai_kualitas':
                                tempData[matrixId].nilai_kualitas =
                                    subObject[subKey]
                                break
                            case 'nilai_pengaruh':
                                tempData[matrixId].nilai_pengaruh =
                                    subObject[subKey]
                                break
                            default:
