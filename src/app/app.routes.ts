...
// export const routes: Routes = [
//   {
//     path: 'sijupri', // Add the prefix here
//     children: [
//       {
//         path: '',
//         redirectTo: '/sijupri', // Redirect to the prefixed path
//         pathMatch: 'full'
//       },
//       getMenus(),
//       {
...
//           ).then(m => m.RejectUkomScheduleComponent)
//       },
//       { path: '**', redirectTo: '/sijupri/not-found' }
//     ]
//   },
//   { path: '', redirectTo: '/sijupri', pathMatch: 'full' } // Redirect root to the prefixed path
// ]
