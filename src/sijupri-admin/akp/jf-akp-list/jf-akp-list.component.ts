...
export class JfAkpListComponent {
  ...
  constructor(private router: Router, private activatedRoute: ActivatedRoute, private jfService: JfService) {
    ...
    this.pagable = new PagableBuilder("/api/v1/akp/search")
      ...
      .addFilter(new PageFilterBuilder("equal").setProperty("nip").withDefaultValue(this.jfNip).build())
