      ...
      this.confirmationService.open(false).subscribe({
        next: (result) => {
          ...
          if (this.addSiapReportForm.value.exportType == 'instansi') {
            reportGenerate.parameter = { instansiId: this.addSiapReportForm.value.instansiId, instansiName: this.addSiapReportForm.value.instansiName }
          }
          if (this.addSiapReportForm.value.exportType == 'unitKerja') {
            reportGenerate.parameter = { unitKerjaId: this.addSiapReportForm.value.unitKerjaId, unitKerjaName: this.addSiapReportForm.value.unitKerjaName }
          }
          if (this.addSiapReportForm.value.exportType == 'provinsi') {
            reportGenerate.parameter = { provinsiId: this.addSiapReportForm.value.provinsiId, provinsiName: this.addSiapReportForm.value.provinsiName }
          }
