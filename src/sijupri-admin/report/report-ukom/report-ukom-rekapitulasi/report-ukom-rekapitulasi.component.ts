...
@Component({
    selector: 'app-report-ukom-rekapitulasi',
    standalone: true,
    imports: [
        PagableComponent,
        ReactiveFormsModule,
    ...
    templateUrl: './report-ukom-rekapitulasi.component.html',
    styleUrl: './report-ukom-rekapitulasi.component.scss',
})
export class ReportUkomRekapitulasiComponent {
    pagable: Pagable
    ...
    handleGenerateReport() {
        this.confirmationService.open(false).subscribe({
            next: ({ confirmed }) => {
                ...
                const formValue = this.addUKomReportForm.value
