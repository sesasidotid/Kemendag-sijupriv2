...
@Component({
    selector: 'app-[unused]ukom-periode',
    standalone: true,
...
export class UkomPeriodeComponent {
                ...
                new ActionColumnBuilder()
                    .setAction((periodePendafatan: any) => {
                        this.router.navigate([
                            `/ukom/ukom-periode/${periodePendafatan.id}`,
                        ])
                    }, 'info')
                    .withIcon('detail')
                    .build(),
    ...
    ngOnInit() {
        ...
        //     isActive: true,
        //     icon: 'mdi-list-box',
        //     onClick: () => this.router.navigate(['/ukom/[unused]ukom-periode'])
        //   })
        //   .addTab({
        //     label: 'Tambah User Instansi',
        //     icon: 'mdi-plus-circle',
        //     onClick: () => this.router.navigate(['/ukom/[unused]ukom-periode/add'])
        //   })
    }
